...
void Beveler::DrawBeveledBrick(const RectF& rect, int bevelSize, Graphics& gfx) const
{
	...
	gfx.DrawRec(rect.GetExpanded(-float(bevelSize)), baseColor);
}
